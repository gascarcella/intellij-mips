...
public class MipsRunConfigurationEditor extends SettingsEditor<MipsRunConfiguration> implements MipsRunConfigurationParams {
  ...
  public MipsRunConfigurationEditor(MipsRunConfiguration cfg) {
    ...
    mainFileField.addBrowseFolderListener(cfg.getProject(), new com.intellij.openapi.ui.ComponentWithBrowseButton.BrowseFolderActionListener<>(
        "MIPS Main File",
        "Choose the MIPS file containing the main function.",
        mainFileField,
        cfg.getProject(),
        getChooseMainFileDescriptor(),
        com.intellij.openapi.ui.TextComponentAccessor.TEXT_FIELD_WHOLE_TEXT
    ));

    workingDirField.addBrowseFolderListener(cfg.getProject(), new com.intellij.openapi.ui.ComponentWithBrowseButton.BrowseFolderActionListener<>(
        "Working Directory",
